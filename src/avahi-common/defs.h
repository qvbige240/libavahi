...
typedef enum {
	...
	AVAHI_SERVER_IPV4_NEW,			// qing added, network opened or switch ap
	AVAHI_SERVER_IPV4_DELETE,		// qing added, network closed
	AVAHI_SERVER_IPV4_DONE,			// qing added, network check done
} AvahiServerState;
